...
public final class BloomFilterMR {
	...
	public static class BloomFilterMapper extends MapReduceBase implements Mapper<LongWritable, Text, Text, BloomFilter<String>> {
		...
		public void map(LongWritable key, Text value,
				OutputCollector<Text, BloomFilter<String>> collector, Reporter reporter)
				throws IOException {
	...
	public static class BloomFilterReducer extends MapReduceBase implements Reducer<Text, BloomFilter<String>, Text, Text> {
		...
		public void close() throws IOException {
			final Path file = new Path(job.get("mapred.output.dir") + "/bloomfilter");
